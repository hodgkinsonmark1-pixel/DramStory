...
// AREAS (21 July 2026, not exhaustive - the "Other" group covers anywhere
// not listed here) now lives in @/lib/areas (06 Aug 2026) so MapCanvas.tsx
// can import the same list for its pin-popup link, without pulling this
// "use client" component into a non-client file.
